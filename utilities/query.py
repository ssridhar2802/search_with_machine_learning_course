...
def search(client, user_query, index="bbuy_products", sort="_score", sortDir="desc", synonyms=True):
...
if __name__ == "__main__":
    ...
    general.add_argument('--synonyms', type=boolean_string, default=True, 
                         help='Specify whether to use close synonyms for matching or not')
